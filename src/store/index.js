    ...
    state: {
        list: {
            ...
            },
            {
                ...
                content: " Удобно покупать билеты с <a href='#'> iOS и Android </a>, следить за результатами розыгрышей и смотреть трансляции. ",
                img: "/twoItem.svg",
                id: 5
            },
            {
                title: "В розничных точках продаж  ",
                content: " На <a href='#'>карте</a> можно найти киоски, лотерейные аппараты и партнёрские магазины: «Почта России», «Связной», «Билайн», «МегаФон», «Ростелеком», Tele2, «Перекрёсток», «Пятёрочка», «Бристоль». ",
                img: "/itemThree.svg",
                id: 6
            },
            {
                title: "Через SMS  ",
                content: " Нужно найти на специальной <a href='#'>странице</a> идентификационный код лотереи и прислать его SMS-сообщением на номер 9999. Деньги спишутся с баланса мобильного телефона. ",
                img: "/fourIcon.svg",
                id: 7
            }
                , {
            ...
            },
            {
                ...
                content: " <a href='#'>Найдите</a> номер тиража, указанный на билете, и узнайте, какие бочонки ведущий вынул из мешка во время трансляции. Либо введите номер билета на <a href='#'>специальной странице </a> и проверьте, счастливый ли он. ",
                img: "/two.svg",
                id: 14
            },
            {
            ...
            },
            {
                ...
                content: " Программа для <a href='#'>iOS и Android</a> предоставляет архив тиражей и присылает push-уведомления со свежими результатами. Также в приложении можно покупать билеты, изучать программу предстоящих розыгрышей и смотреть трансляции. ",
                img: "/four.svg",
                id: 16
            }
                , {
            ...
            },
            {
                ...
                content: " Чтобы найти подходящую точку, нужно выбрать на странице с <a href='#'>картой</a> «Столото» пункт «Получить выигрыш» и ввести сумму выигрыша.",
                img: "/bTwo.svg",
                id: 21
            },
            {
                title: "Перевести на лицевой счёт — от 100 000 рублей   ",
                content: " Для получения выигрыша нужно предоставить комплект документов и реквизиты счёта. Подробности — на <a href='#'>сайте «Столото».</a>",
                img: "/bThree.svg",
                id: 22
            },
            {
